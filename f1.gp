...
set output 'svg/Rio_Grande_do_Sul-16.svg'
...
plot 'gpdata/dat/Rio_Grande_do_Sul-16.dat' using 1:2 w lines title 'S', '' using 1:3 w lines title 'Q', '' using 1:8 w lines title 'R'
