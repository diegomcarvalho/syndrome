...
plot 'gpdata/dat/Brazil-16.dat' using 1:4 w lines title 'E', '' using 1:5 w lines title 'A', '' using 1:6 w lines title 'I', '' using 1:7 w lines title 'D', '' using 1:9 w lines title 'M'
